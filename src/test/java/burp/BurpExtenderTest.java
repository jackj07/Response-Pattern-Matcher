...
class BurpExtenderTest {
    ...
    void JacksonParserTest() {
        ...
        try {
            ...
            ResultEntry result3 = new ResultEntry(3, 2, new URL("https://www.lipsum.com/"), null, "port:3234", "port");
            ResultEntry result4 = new ResultEntry(4, 3, new URL("http://test2.com"), null, "/body> password is <b>welc0me2</b>", "password");
